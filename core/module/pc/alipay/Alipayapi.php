...
class Alipayapi extends BaseAction{
	
	public function action(){
		require $_SERVER['DOCUMENT_ROOT'].'/core/module/pc/alipay/alipay.config.php';
		require_once $_SERVER['DOCUMENT_ROOT'].'/core/module/pc/alipay/lib/alipay_submit.class.php';
