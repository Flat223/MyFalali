...
class Purchase extends BaseAction{
	
	public function action(){
		$user = UserAgent::getUser();
		
		//公司'采购员'并且绑定了企业,或者是公司本身
		if($user['type'] != 2 || $user['sub_type'] == 1 || ($user['sub_type'] != 0 && $user['bind_status'] != 2)){
		...
		$params = array();
		$params['style'] = 'user';
		$params['substyle'] = 'purchase';
		$params['purchase'] = $newOrderArray;
