	...
	var handle = {
 		init:function() {
			...
			$(".groupbuy").click(function(){
				...
				window.location.href="/shopping/process.html?type=3&id="+id;
			...
			$("#buy_now").click(function(){
				...
				if(pid<=0){
					...
					window.location.href="/mall/buyProgress.html?type=2&skuid="+skuid+"&num="+$('.text').val()+"&pid="+pid+"&testing="+testing+"&guarantee="+year+"&aid="+userInfo['address_id'];			
				}
			});	
			$(".more").click(function(){
