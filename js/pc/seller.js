define(function(require){
    ...
    var handle = {
        init:function(){
            // showcompare();
            //alert(getCookie('pid'));
            $("span[class=button-span1]").on("click",function(){
                var cid=$(this).attr('value');
                var sid=id;
                $.ajax({
                    type:"post",
                    dataType:"json",
                    url:"/service/GetCouponNewTServ.html",
                    data:{"cid":cid,"sid":sid,"type":1},
            ...
            $(".sort ul li").click(function () {
                ...
                window.location.href="/brand/seller.html?id="+id+"&type="+type+"&sort="+newrank;

            });
            $(".category span").click(function () {
                $(this).addClass("act-a").siblings().removeClass("act-a");
                var newtype=$(this).attr('value');
                window.location.href="/brand/seller.html?id="+id+"&type="+newtype+"&sort=1";
            });
