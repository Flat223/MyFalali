...
var iChukCore = {
	Inital:function(){
		...
		*</div>
		*/
		cc.InitOnOff = function(object,callback){
		    var OnOffObj = $(object);
		...
		*/
		...
		cc.Calendar = function(target,callback,widthtype,season,dayclick){// widthtype->宽度类型 0 设备宽度 1 父元素宽度
			...
			//console.log(time);
			var calendarHtml = "<div id=\'canlendar_"+rand+"\' style=\'background-color: white;font-size: 14px;border: 1px solid #ccc;width:"+_width_+"px;height:"+_height_+"px;color:gray;text-align: center;\'>\
			                ...
			                <div class=\'section_center\' style=\'height:"+section_center_height+"px;\'>\
			                    <ul style=\'border-right:1px solid #ccc;border-bottom:1px solid #ccc;font-size: 23px;float:left;height:"+(section_center_height-1)+"px;width:"+(handle_mounth_width-1)+"px;\' data-type=\'mounth\' data=\'"+time.month+"\' class=\'handle handle-mounth\'>\
			                        <li data-ref=\'plus\' class=\'mounth-handle\' style=\'line-height:50px;height:50px;cursor: pointer;\'>&and;</li>\
			                        <li class=\'mounth-show\' style=\'line-height:"+(section_center_height-100)+"px;height:"+(section_center_height-100)+"px;\'>"+time.month+"月</li>\
			                        <li data-ref=\'minus\' class=\'mounth-handle\' style=\'line-height:50px;height:50px;cursor: pointer;\'>&or;</li>\
			                    </ul>\
			                ...
			                if(season)
			                {
								calendarHtml += "<div class=\'section_bottom\' style=\'  font-size: 14px;height:"+season_height+"px;line-height:"+season_height+"px;\'>\
		...
		cc.InitDialogFrame = function(title,content,jsonconfig)
			{
			    ...
			    var html = "<div style=\'width: 100%;height: 100%;position: fixed;top: 0;z-index:2;background-color: rgba(0, 0, 0, 0.6);\'>\
